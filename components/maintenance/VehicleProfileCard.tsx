...
export default function VehicleProfileCard({ vehicle, onOdometerUpdate, onEditVehicle }: VehicleProfileCardProps) {
  ...
  const handleConfirm = () => {
    ...
    if (!isNaN(parsed) && parsed > vehicle.currentOdometer) {
  ...
  return (
    ...
    >
      ...
      <View style={{ backgroundColor: '#1A2B3C', padding: 20, gap: 16 }}>
        ...
        >
          <Text style={{ color: 'rgba(255,255,255,0.4)', fontSize: 11, letterSpacing: 1.5, marginBottom: 8 }}>
            ODOMETER
          </Text>
          ...
          {editing ? (
            ...
            <TouchableOpacity onPress={() => setEditing(true)} activeOpacity={0.9}>
              <View style={{ flexDirection: 'row', alignItems: 'baseline', gap: 4 }}>
                ...
                <Text style={{ color: 'rgba(255,255,255,0.5)', fontSize: 14 }}>km</Text>
                <View
                  style={{
                    marginLeft: 8,
